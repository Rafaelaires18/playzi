...
export default function BottomNavigation({ isHidden = false, activeTab = "discover" }: BottomNavigationProps) {
    ...
    return (
        <div
            className={cn(
                "fixed bottom-0 left-0 right-0 z-40 mx-auto w-full max-w-md transition-transform duration-300 ease-in-out",
        ...
        >
            ...
            <div className="relative flex h-20 items-center justify-around px-4 pb-4">
