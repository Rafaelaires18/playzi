...
import { HelpCircle, ChevronRight, Mail, Sparkles } from "lucide-react";
import {
            ...
            <div className="flex-1 overflow-y-auto px-6 pb-12 pt-24 space-y-8 bg-gray-50/50">
                ...
                <section>
                    ...
                    <button
                        ...
                        onClick={() => startPlayziOnboarding("support_page")}
                    ...
                    >
                        <span className="flex items-center gap-2">
                            ...
                            <span>
                                <span className="block text-[13px] font-black text-emerald-800">Voir le tutoriel</span>
                                <span className="block text-[12px] font-semibold text-emerald-700/80">Besoin d&apos;aide ? Rejoue le guide Playzi</span>
                            </span>
                        </span>
                        ...
                        {faqs.map((faq) => {
                            ...
                            return (
                                <div key={faq.question} className={`border-b border-gray-50 last:border-b-0 ${isOpen ? 'bg-gray-50/30' : ''}`}>
                                    ...
                                    >
                                        <span className={`text-[16px] leading-snug font-bold ${isOpen ? 'text-[#2D2E3B]' : 'text-gray-500'}`}>
                                            {faq.question}
                                        </span>
                                    ...
                                    {isOpen && (
                                        <div className="px-5 pb-5 pt-1">
                                            <p className="whitespace-pre-line text-[14px] leading-relaxed text-gray-500 font-medium">
                                                {faq.answer}
                                            </p>
                                        </div>
                                    )}
