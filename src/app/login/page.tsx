                ...
                >
                    ...
                    <div className="flex justify-center">
                        <button
                            ...
                            className="flex h-[48px] w-[64px] items-center justify-center rounded-[12px] border border-gray-200 bg-white transition-all hover:bg-gray-50 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            <svg className="h-[24px] w-[24px]" aria-hidden="true" viewBox="0 0 24 24">
